  ...
  return (
    <div className="relative w-75 sm:w-full sm:max-w-md">
      ...
      <input
        ...
        className="bg-surface-1 placeholder:text-muted focus:border-muted w-full rounded-full border border-transparent px-12 py-1.5 text-base transition-colors duration-150 placeholder:font-light focus:outline-none"
      />
      <button
        type="button"
